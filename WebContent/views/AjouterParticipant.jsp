...
<link href="views/assets/libs/datatables/select.bootstrap4.css"
	...
	rel="stylesheet" type="text/css" />
<title>Ajoute Participant</title>
...
<script type="text/javascript">
	function confirmation(id) {
		...
		if (conf == true) {
			document.location = "ParticipantServlet?action=supprimer&id=" + id;
		}
	}
</script>
</head>
						...
						<div class="row">
							<div class="col-12">
								<div class="page-title-box">
									...
									<h4 class="page-title">Participants
									<%if("exite".equals(request.getAttribute("error"))){%>
									<script>alert("Vous ne pouvez pas supprimer un participant appartient dans des conventions");</script>
									<%} %>
									</h4>
								</div>
							</div>
										...
										<div class="row">
											<div class="col-lg-4">
												...
												<div class="form-group mb-3">
													<label for="simpleinput">Titre</label> <input type='text'
														name="designation" value="${participant.libelle}"
														class=" form-control inputtop" placeholder="">
											...
											<div class="col-lg-4">
												...
												<div class="form-group mb-3">
													...
													<label for="simpleinput">Logo</label> <input type="file" accept="image/*"
														name=file class="inputtop form-control" src="data:image/jpeg;base64,${participant.logo}"  value="${participant.libelle}"  >
												</div>
											</div>
											...
											<div class="col-lg-4">
												...
												<div class="form-group mb-3">
													...
													<c:if test="${participant!=null}">
														...
														id="sa-success"	class="btn btn-primary btn-block mt-3 waves-effect waves-light">
									...
									<table border="1" WIDTH=100% id="basic-datatable"
										...
										<thead>
											<tr
												...
												<th class="text-center">Titre du participant</th>
										...
										<tbody>
											<c:forEach items="${participants}" var="p">
												<tr>
													...
													<td><img src="data:image/jpeg;base64,${p.logo}" width="50px" height="50px" /></td>
													

													<td><a
														href="ParticipantServlet?action=modif&id=${p.id}"
														class="action-icon"> <i
